                ...
                <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <tr>
                                @foreach ($DislikeFoods as $DislikeFood)
                                    ...
                                    <td data-label="操作">
                                        ...
                                        <a href="{{ route('DislikeFood.edit', $DislikeFood->id) }}" class="edit mx-1">
                                        ...
                                        <form id="del_icon"
                                            ...
                                            <a href="{{ 'DislikeFood/delete/' }}{{ $DislikeFood->id }}" class=" mx-1"
                    ...
                    <div style="width:85%;margin:auto;  class=" mt-1" class="d-flex">
                        <div class="card-body d-flex justify-content-end mr-0">
                            {{ $DislikeFoods->appends(['search' => request()->search])->links('vendor.pagination.bootstrap-5') }}
                        </div>
                    </div>
