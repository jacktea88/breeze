...
<body>
  <div class="row">
    <div class="col-md-12">
      ...
      <form action="{{ url('/OftenDiner') }}" method="post">
        <h1>新增常去的餐館與餐點</h1>
        @csrf
        <fieldset>
          ...
          <input type="text" name="of_diner" value="{{ old('of_diner') }}">
          ...
          <input type="text" name="of_meal" value="{{ old('of_meal') }}">
          ...
          <input type="text" name="of_address" value="{{ old('of_address') }}">
