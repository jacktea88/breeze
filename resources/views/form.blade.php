...
@foreach ($dislikes as $dislike)
    {!! Form::label('dislikes[]', $dislike->foodName, []) !!}
    {!! Form::checkbox('dislikes[]', $dislike->id, false) !!}
@endforeach
    ...
    <br><br>{!! Form::label('mode2:', '模式', []) !!}
    經典下拉
    {!! Form::select('mode3', ['recommend'=>'編輯精選','season'=>'當季商品','cp'=>'超值商品'],null, ['placeholder' => '請選擇商品模式']) !!}
    分群下拉
    {!! Form::select('mode1', ['時節'=>['summer' => '夏日熱銷','winter'=>'冬節獻禮'],'價格'=>['cp'=>'超值商品','boss'=>'老闆跳樓']],null, []) !!}

    <br><br>選項由後台提供
    {!! Form::select('dislike_food', $dislikes->foodName,null, []) !!}
